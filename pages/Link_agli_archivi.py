...
if st.session_state["authentication_status"]:
        ...
        Applica i filtri che trovi sulla sinistra per visualizzare i risultati qui sotto.  
        Se la tabella é vuota vuol dire che non ci sono link per i filtri selezionati.
        """)
